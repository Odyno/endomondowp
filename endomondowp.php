...
include_once EWP_DIR . '/include/ewp-lib.php';
include_once EWP_DIR . '/include/ewp-shortcode.php';
include_once EWP_DIR . '/include/ewp-media-buttom.php';

 ...
 *
 */
function do_endomondowp($endomondoId, $workout_id, $challenge_id = null, $event_id = null, $team_id = null, $type = EWP_LAST_WORKOUT, $id = null, $width = EWP_DEFAUTL_WIDTH, $height = EWP_DEFAUTL_HEIGHT)
{
    ...
    do_action("pre_ewp_show", $endomondoId, $workout_id, $challenge_id, $event_id, $team_id, $id, $width, $height);
    echo ewp_get_page($endomondoId, $workout_id, $challenge_id, $event_id, $team_id, $id, $type, $width, $height);
    do_action("post_ogg_show", $endomondoId, $workout_id, $challenge_id, $event_id, $team_id, $id, $width, $height);
}
 ...
 * @return string
 */
function ewp_get_page($user, $workout_id = null, $challenge_id = null, $event_id = null, $team_id = null, $id = null, $type = null, $width = EWP_DEFAUTL_WIDTH, $height = EWP_DEFAUTL_HEIGHT)
{
    ...
    switch ($type) {
        case EWP_WORKOUT:
            $out .= ewp_workout_html($user, $workout_id, $id, $width, $height);
            break;
...
function ewp_workout_html($user, $workout_id, $id, $width, $height)
{
    if ($user == "null") {
        $out = "The \"workout_id\"  is MANDATORY";
    } else {
        $out = '<iframe
